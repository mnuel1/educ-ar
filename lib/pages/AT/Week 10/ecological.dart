...
void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) => UpdateNotify("assets/lesson10/lesson10Subtitles/AT/subtitle.json"),
...
class _ModuleScreenPage extends State<ModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"", modelPath:"assets/lesson10/assets/lion.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
    SceneNode(name:"", modelPath:"assets/lesson10/assets/zebra.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
    SceneNode(name:"", modelPath:"assets/lesson10/assets/spider.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
    SceneNode(name:"", modelPath:"assets/lesson10/assets/fly.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
    SceneNode(name:"", modelPath:"assets/lesson10/assets/snake.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
