...
class _MicroscopeModulePage extends State<MicroscopeModuleScreen> {
  ...
  int objectBoardIndex = 1;
    List<SceneNode> sceneNodes = [
      ...
      SceneNode(name: "Objective Lens 4x", modelPath: "assets/lesson1&2/assets/4x/4x.gltf", position: vector.Vector3(0.0001, 0.145, 0.022), scale: vector.Vector3(0.45, 0.6, 0.6)),
      SceneNode(name: "Objective Lens 10x", modelPath: "assets/lesson1&2/assets/8x/8x.gltf", position: vector.Vector3(-0.01, 0.146, 0.038), scale: vector.Vector3(0.62, 0.7, 0.6)),
      SceneNode(name: "Objective Lens 40x", modelPath: "assets/lesson1&2/assets/40x/40x.gltf", position: vector.Vector3(0.0, 0.14, 0.045), scale: vector.Vector3(0.7, 0.9, 0.6)),
      SceneNode(name: "Objective Lens 100x", modelPath: "assets/lesson1&2/assets/100x/100x.gltf", position: vector.Vector3(0.015, 0.15, 0.038), scale: vector.Vector3(0.7, 0.7, 0.6)),
