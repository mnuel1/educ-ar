...
void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) => UpdateNotify("assets/lesson4/lesson4Subtitles/AT/subtitle.json"),
...
class _MicroscopeModulePage extends State<MicroscopeModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"nucleus", modelPath:"assets/lesson4/assets/nucleus.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.25, .25, .25)),
