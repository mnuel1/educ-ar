...
class _ModuleScreenPage extends State<ModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"", modelPath:"assets/lesson9/assets/producers.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.1, .1, .1)),
    SceneNode(name:"", modelPath:"assets/lesson9/assets/consumers.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.1, .1, .1)),
    SceneNode(name:"", modelPath:"assets/lesson9/assets/decomposers.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.1, .1, .1)),
    SceneNode(name:"", modelPath:"assets/lesson9/assets/abiotic.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.1, .1, .1)),
