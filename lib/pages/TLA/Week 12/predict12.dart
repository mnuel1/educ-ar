...
class _ModuleScreenPage extends State<ModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"", modelPath:"assets/lesson12/assets/cons1.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.15, .15, .15)),
    SceneNode(name:"", modelPath:"assets/lesson12/assets/cons2.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.15, .15, .15)),
    SceneNode(name:"", modelPath:"assets/lesson12/assets/cons3.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.15, .15, .15)),
    SceneNode(name:"", modelPath:"assets/lesson12/assets/cons4.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.15, .15, .15)),
    SceneNode(name:"", modelPath:"assets/lesson12/assets/cons5.gltf", position:vector.Vector3(0, 0, 0), scale:vector.Vector3(.15, .15, .15)),
