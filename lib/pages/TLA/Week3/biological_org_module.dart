...
void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) => UpdateNotify("assets/lesson3/lesson3Subtitles/TLA/subtitle.json"),
...
class _ModuleScreenPage extends State<ModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"pyramid", modelPath:"assets/lesson3/assets/org/pyramid.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.1, .1, .1)),
  ];
