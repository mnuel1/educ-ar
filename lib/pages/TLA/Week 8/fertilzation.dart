...
void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) => UpdateNotify("assets/lesson8/lesson8Subitles/TLA/subtitle.json"),
...
class _ModuleScreenPage extends State<ModuleScreen> {
  ...
  List<SceneNode> sceneNodes = [
    ...
    SceneNode(name:"", modelPath:"assets/lesson8/assets/spermeggarrow.gltf", position:vector.Vector3(0.015, -0.01, 0.048), scale:vector.Vector3(.5, .5, .5)),
